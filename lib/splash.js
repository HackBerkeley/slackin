...
export default function splash({ name, logo, active, total, channel, iframe }){
  let div = dom('.splash',
    ...
    dom('p',
      'We are ', dom('b', dom('a href="http://hackersatberkeley.com"', name), '.')
    ),
    dom('p',
      "We're a community of hackers, engineers, and designers at UC Berkeley.",
      dom('br'),
      "We hold workshops, hackathons, hack nights, hacker fairs, and more.",
      dom('br'),
      "Join our community online."
    ),
    dom('br'),
    dom('p', 
      "If you're already registered, go to ", dom('b', dom('a href="https://hackersatberkeley.slack.com"', 'hackersatberkeley.slack.com'))
    ),
    dom('p.status',
      active
        ? [
    ...
    dom('p',
      "<small>Keep <i>relevant</i> job/event posts to the right channel.</small>"
    ),
    !iframe && dom('footer',
      'powered by ',
